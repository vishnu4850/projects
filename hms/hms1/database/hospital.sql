...
(1, 31, 'Audiologist', 'help hello', NULL, NULL, 'no'),
(2, 32, 'Dentist', 'erfe', NULL, NULL, 'no'),
(3, 33, 'Endocrinologist', 'nill', NULL, NULL, 'no'),
(4, 34, 'Endocrinologist', 'dcdfc', NULL, NULL, 'no'),
(5, 35, 'Endocrinologist', 'dsd', NULL, NULL, 'no');
...
--
ALTER TABLE `appointments`
  MODIFY `appointment_no` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `patient_info`
--
ALTER TABLE `patient_info`
  MODIFY `patient_Id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
COMMIT;
